...
util.url = function(e, t) {
  var n = getApp()
  var a = n.siteInfo.siteroot + e +"?i=" + n.siteInfo.uniacid + "&t=" + n.siteInfo.multiid + "&v=" + n.siteInfo.version + "&from=wxapp&";
      ...
      wx.login({
          success: function(e) {
              util.request({
                ...
                success: function(e) {
                  if(e.data.code == 200){
                    t.sessionid = e.data.data.sessionid
