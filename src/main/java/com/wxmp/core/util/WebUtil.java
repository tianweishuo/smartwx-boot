...
public class WebUtil {
	...
	public static String getAppbaseUrl(HttpServletRequest request, String url){
		Assert.hasLength(url, "[Assertion failed] - this String argument must have length; it must not be null or empty");
		//Assert.hasLength(url);
		Assert.isTrue(url.startsWith(PREFIX_URL), "[Assertion failed] - this expression must be true");
